<?php
    ...
    $fbconfig['appid' ]     = "567297833366233";
    $fbconfig['secret']     = "a9dac9441aec705e814ef96239b0c386";
    $fbconfig['baseurl']    = "http://vthallam.com/FBTest"; 
        ...
        if (isset($_GET['publish'])){
            try {
                $publishStream = $facebook->api("/$user/feed", 'post', array(
                    'message' => "Checking an fb auto post :)", 
                    'link'    => 'http://test.com',
                    'picture' => '',
                    'name'    => 'Job Board',
                    'description'=> ''
