        ...
        <script type="text/javascript">
            function streamPublish(name, description, hrefTitle, hrefLink, userPrompt){        
                FB.ui({ method : 'feed', 
                        ...
                        link   :  hrefLink,
                        caption:  hrefTitle,
                        picture: 'http://2014s.pennapps.com/build/images/logo-light-with-shadow.png'
               });
               //http://developers.facebook.com/docs/reference/dialogs/feed/
   
            }
            function publishStream(){
                streamPublish("Stream Publish", 'PennApps - One Awesome Hackathon', 'Checkout PennApps', 'http://vthallam.com/FBTest', "Demo Facebook Application Post");
            }
            
            function newInvite(){
                 var receiverUserIds = FB.ui({ 
                        method : 'apprequests',
                        message: 'You should come to PennApps in the Fall',
                 },
